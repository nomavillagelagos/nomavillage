...
export default function LandingPageC() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Simple Pricing (1200 €/month) */}
      <section id="pricing" className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <p className="font-montserrat text-sm text-gray-500 mb-2">From <span className="font-semibold text-gray-800">€1,200/month</span></p>
            ...
            <div className="relative border-2 border-lagos-blue-green rounded-2xl p-8 shadow-xl bg-gradient-to-br from-white to-gray-50">
              <div className="text-center mb-6">
                <div className="flex items-end justify-center gap-2 mb-1">
                  <span className="text-5xl font-bold text-gray-900 font-montserrat">€1,200</span>
                  <span className="text-gray-500 font-nunito pb-2">/ month</span>
                </div>
                <div className="text-lagos-blue-green font-montserrat font-semibold mb-2">~ €40/day</div>
