...
export const metadata: Metadata = {
  ...
  description: 'Experience coliving & coworking in Lagos, Algarve, Portugal. Private rooms from €644/2 weeks, 500 Mbps WiFi, daily yoga, surf lessons, vibrant digital nomad community. 10 min to beach. Book now!',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Private rooms from €644/2 weeks. 500 Mbps WiFi, daily yoga, surf, beach lifestyle. Join 175+ digital nomads in Lagos, Algarve, Portugal.',
