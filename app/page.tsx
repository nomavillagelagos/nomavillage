...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
            ...
            __html: JSON.stringify([
              {
                ...
                "thumbnailUrl": "https://nomavillage.com/images/cliff2.jpg",
              ...
              },
              {
                ...
                "thumbnailUrl": "https://nomavillage.com/images/hero.jpg",
      ...
      {/* Hero Section */}
      <section id="hero" className="relative h-[93vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="font-nunito text-base text-gray-600 mb-6 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
                <div>
                  <div className="text-4xl font-montserrat font-bold text-gray-900">€550</div>
      ...
      {/* Stats Section */}
      <section id="stats" className="py-10 bg-gradient-to-br from-lagos-aquamarine/30 to-lagos-blue-green/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section id="join-us" className="py-20 bg-gradient-to-br from-lagos-aquamarine/5 via-white to-lagos-blue-green/5">
      ...
      {/* Guest Story (Jeremy) */}
      <section id="guest-story" className="py-20 bg-white">
